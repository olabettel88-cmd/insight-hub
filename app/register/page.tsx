      ...
      <div className="relative z-10 w-full max-w-md lg:max-w-sm">
        ...
        {step === 'api-key' && (
          <div className="cyber-glass border border-[rgba(236,19,19,0.2)] p-8 space-y-6">
            ...
            <div className="bg-black/40 border-2 border-[rgba(236,19,19,0.5)] p-4 rounded">
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#ec1313] mb-2">API_KEY_GENERATED</p>
              <p className="font-mono text-xs text-slate-300 break-all mb-4">{apiKey}</p>
              <button
                onClick={copyToClipboard}
                className="w-full bg-[rgba(236,19,19,0.2)] border border-[#ec1313] text-[#ec1313] hover:bg-[rgba(236,19,19,0.3)] py-2 rounded text-xs font-bold uppercase tracking-widest transition-colors"
              >
                {copied ? 'COPIED_✓' : 'COPY_KEY'}
              </button>
            </div>
